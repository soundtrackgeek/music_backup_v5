...
| Timeline | Implemented | Standalone dark album-debut ribbon with year/preset/custom-month/week navigation, cover selection and fullscreen hover previews, playlist handoff, album entry, responsive layout, and fullscreen. |
...
- Search and Charts expose chart-debut week from/to filters, columns, sorting, and exports. The standalone Timeline workspace adds a decade-spanning album ribbon; Spring, Summer, Fall, Winter, Christmas, New Year, and full-year presets; custom single-month or wrapping month-range views; exact-album playlist handoff; and fullscreen hover artwork. Luna Search, Chart, and Playlist Builder plans can compile chart-debut periods and named seasons to local week ranges.
