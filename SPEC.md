...
| Timeline | Implemented | Standalone dark album-debut ribbon with year/season/week navigation, cover selection, playlist handoff, album entry, responsive layout, and fullscreen. |
...
- Search and Charts expose chart-debut week from/to filters, columns, sorting, and exports. The standalone Timeline workspace adds a decade-spanning album ribbon, seasonal week views, exact-album playlist handoff, and fullscreen; Luna Search, Chart, and Playlist Builder plans can compile chart-debut periods and named seasons to local week ranges.
