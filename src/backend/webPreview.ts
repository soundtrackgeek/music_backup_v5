...
const mockDiscovery: DiscoveryResponse = {
  dailyEdition: {
    ...
    ratingAnchor: {
      ...
      album: "Actually",
      artist: "Pet Shop Boys",
      createdAt: "2026-08-11T08:40:00Z",
      rating: 86,
      coverPath: mockTimelineCoverUrls[0],
      evidence: "Rated 86 · recent library rating activity",
    },
    becauseYouPlayed: [
      {
        ...
        coverPath: mockTimelineCoverUrls[2],
        reason: "Shared genre",
        evidence: "Shared genre · 6 loved tracks",
      },
      {
        ...
        coverPath: mockTimelineCoverUrls[3],
        reason: "Shared genre",
        evidence: "Shared genre · 4 loved tracks",
      },
      {
