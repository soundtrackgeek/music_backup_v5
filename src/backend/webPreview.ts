...
const mockDiscovery: DiscoveryResponse = {
  ...
  dailyEdition: {
    ...
    lifeEvents: [
      {
        ...
        representativeAlbumId: "mb:mock-life-1",
        representativeAlbum: "Don't Be Cruel",
        representativeCoverPath: mockTimelineCoverUrls[2],
        evidence: "Born today · 2 albums in your library",
      },
      {
        artistId: "john sebastian",
        artist: "John Sebastian",
        eventType: "birthday",
        eventDate: "1944-08-11",
        years: 82,
        dayOffset: 0,
        albumCount: 1,
        lovedTracks: 1,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-life-2",
        representativeAlbum: "John B. Sebastian",
        representativeCoverPath: mockTimelineCoverUrls[3],
        evidence: "Born today · 1 album in your library",
      },
      {
        artistId: "joe jackson",
        artist: "Joe Jackson",
        eventType: "birthday",
        eventDate: "1954-08-11",
        years: 72,
        dayOffset: 0,
        albumCount: 8,
        lovedTracks: 6,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-life-4",
        representativeAlbum: "Night and Day",
        representativeCoverPath: mockTimelineCoverUrls[4],
        evidence: "Born today · 8 albums in your library",
      },
      {
        artistId: "eric carmen",
        artist: "Eric Carmen",
        eventType: "birthday",
        eventDate: "1949-08-11",
        years: 77,
        dayOffset: 0,
        albumCount: 5,
        lovedTracks: 3,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-life-5",
        representativeAlbum: "Eric Carmen",
        representativeCoverPath: mockTimelineCoverUrls[5],
        evidence: "Born today · 5 albums in your library",
      },
      {
        artistId: "richie ramone",
        artist: "Richie Ramone",
        eventType: "birthday",
        eventDate: "1957-08-11",
        years: 69,
        dayOffset: 0,
        albumCount: 3,
        lovedTracks: 2,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-life-6",
        representativeAlbum: "Entitled",
        representativeCoverPath: mockTimelineCoverUrls[0],
        evidence: "Born today · 3 albums in your library",
      },
      {
        artistId: "robin williams",
        artist: "Robin Williams",
        eventType: "memorial",
        eventDate: "2014-08-11",
        years: 12,
        dayOffset: 0,
        albumCount: 4,
        lovedTracks: 4,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-memorial-1",
        representativeAlbum: "Live 2002",
        representativeCoverPath: mockTimelineCoverUrls[4],
        evidence: "Remembered today · 4 loved tracks",
      },
      {
        artistId: "jani lane",
        artist: "Jani Lane",
        eventType: "memorial",
        eventDate: "2011-08-11",
        years: 15,
        dayOffset: 0,
        albumCount: 3,
        lovedTracks: 3,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-memorial-2",
        representativeAlbum: "Back Down to One",
        representativeCoverPath: mockTimelineCoverUrls[3],
        evidence: "Remembered today · 3 loved tracks",
      },
      {
        artistId: "sonny thompson",
        artist: "Sonny Thompson",
        eventType: "memorial",
        eventDate: "1989-08-11",
        years: 37,
        dayOffset: 0,
        albumCount: 2,
        lovedTracks: 2,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-memorial-3",
        representativeAlbum: "Long Gone",
        representativeCoverPath: mockTimelineCoverUrls[2],
        evidence: "Remembered today · 2 loved tracks",
      },
      {
        artistId: "mike douglas",
        artist: "Mike Douglas",
        eventType: "memorial",
        eventDate: "2006-08-11",
        years: 20,
        dayOffset: 0,
        albumCount: 2,
        lovedTracks: 1,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-memorial-4",
        representativeAlbum: "The Men in My Little Girl's Life",
        representativeCoverPath: mockTimelineCoverUrls[1],
        evidence: "Remembered today · 1 loved track",
      },
      {
        artistId: "tal farlow",
        artist: "Tal Farlow",
        eventType: "memorial",
        eventDate: "1998-08-11",
        years: 28,
        dayOffset: 0,
        albumCount: 1,
        lovedTracks: 1,
        portraitAvailable: false,
        representativeAlbumId: "mb:mock-memorial-5",
        representativeAlbum: "The Tal Farlow Album",
        representativeCoverPath: mockTimelineCoverUrls[0],
        evidence: "Remembered today · 1 loved track",
      },
    ],
    chartSnapshot: {
      ...
      year: 1986,
      week: 34,
      availableYears: [2005, 1986, 1982],
      availableWeeks: [12, 34, 50],
      stories: [
      {
        entity: "album",
        albumId: "mb:mock-chart-1",
        trackId: null,
        title: "True Blue",
        artist: "Madonna",
        album: "True Blue",
      ...
      },
      {
        ...
        loved: false,
        coverPath: mockTimelineCoverUrls[2],
        evidence: "#2 on Official UK Albums · owned album",
      },
      {
        entity: "album",
        albumId: "mb:mock-chart-3",
        trackId: null,
        ...
        loved: false,
        coverPath: mockTimelineCoverUrls[3],
        evidence: "#3 on Official UK Albums · owned album",
      },
      {
        entity: "album",
        albumId: "mb:mock-chart-4",
        trackId: null,
        ...
        loved: false,
        coverPath: mockTimelineCoverUrls[4],
        evidence: "#4 on Official UK Albums · owned album",
      },
      {
        entity: "album",
        albumId: "mb:mock-chart-5",
        trackId: null,
        ...
        chartYear: 1986,
        loved: false,
        coverPath: mockTimelineCoverUrls[5],
        evidence: "#5 on Official UK Albums · owned album",
      },
      ],
    },
    deepCutSnapshot: {
      ...
      decade: null,
      genre: null,
      availableYears: [2013, 2004, 1991, 1984, 1980, 1971],
      availableGenres: [
      ...
      matchingAlbumCount: 6,
      stories: [
      {
        trackId: 911,
        title: "Passing Afternoon",
        albumId: "mb:mock-deep-1",
        ...
        genre: "Folk",
        coverPath: mockTimelineCoverUrls[0],
        evidence: "Album rated 91 · track unrated · no imported singles-chart match",
      },
      {
        trackId: 912,
        title: "All My Rowdy Friends",
        albumId: "mb:mock-deep-2",
        ...
        genre: "Rock",
        coverPath: mockTimelineCoverUrls[1],
        evidence: "Album rated 90 · track unrated · no imported singles-chart match",
      },
      {
        trackId: 913,
        title: "When You Were Mine",
        albumId: "mb:mock-deep-3",
        album: "Dirty Mind",
        artist: "Prince",
        trackNumber: 3,
        timeSeconds: 224,
        ...
        genre: "Pop",
        coverPath: mockTimelineCoverUrls[2],
        evidence: "Album rated 89 · track unrated · no imported singles-chart match",
      },
      {
        trackId: 914,
        title: "Wagon",
        albumId: "mb:mock-deep-4",
        album: "Murmur",
        artist: "R.E.M.",
        trackNumber: 9,
        timeSeconds: 249,
        ...
        genre: "Rock",
        coverPath: mockTimelineCoverUrls[3],
        evidence: "Album rated 88 · track unrated · no imported singles-chart match",
      },
      {
        trackId: 915,
        title: "Weightless",
        albumId: "mb:mock-deep-5",
        ...
        genre: "Ambient",
        coverPath: mockTimelineCoverUrls[4],
        evidence: "Album rated 93 · track unrated · no imported singles-chart match",
      },
      {
        trackId: 916,
        title: "The Sun",
        albumId: "mb:mock-deep-6",
        ...
        genre: "Jazz",
        coverPath: mockTimelineCoverUrls[5],
        evidence: "Album rated 95 · track unrated · no imported singles-chart match",
      },
      ],
    },
    completionSnapshot: {
      ...
      decade: null,
      genre: null,
      availableYears: [2024, 2003, 1999, 1988, 1984, 1981, 1977],
      availableGenres: [
        { id: "jazz", label: "Jazz" },
        { id: "pop", label: "Pop" },
      ...
      artistStories: [
        {
          artistId: "the cure",
          artist: "The Cure",
          musicbrainzMbid: "mock-cure",
          ownedAlbumCount: 11,
          officialAlbumCount: 14,
          missingAlbumCount: 3,
          completionPercent: 0.79,
          missingReleaseTitle: "Songs of a Lost World",
          missingReleaseYear: 2024,
          genre: "Post-Punk",
          portraitAvailable: false,
          representativeAlbumId: "mb:mock-complete-1",
          representativeAlbum: "Disintegration",
          representativeCoverPath: mockTimelineCoverUrls[0],
          evidence: "11 of 14 official albums owned · 13 local albums",
        },
        {
          artistId: "steely dan",
          artist: "Steely Dan",
          musicbrainzMbid: "mock-steely-dan",
          ownedAlbumCount: 7,
          officialAlbumCount: 9,
          missingAlbumCount: 2,
          completionPercent: 0.78,
          missingReleaseTitle: "Everything Must Go",
          missingReleaseYear: 2003,
          genre: "Rock",
          portraitAvailable: false,
          representativeAlbumId: "mb:mock-complete-2",
          representativeAlbum: "Aja",
          representativeCoverPath: mockTimelineCoverUrls[4],
          evidence: "7 of 9 official albums owned · 8 local albums",
        },
        {
          artistId: "talking heads",
          artist: "Talking Heads",
          musicbrainzMbid: "mock-talking-heads",
          ownedAlbumCount: 7,
          officialAlbumCount: 8,
          missingAlbumCount: 1,
          completionPercent: 0.88,
          missingReleaseTitle: "Naked",
          missingReleaseYear: 1988,
          genre: "Post-Punk",
          portraitAvailable: false,
          representativeAlbumId: "mb:mock-complete-3",
          representativeAlbum: "Remain in Light",
          representativeCoverPath: mockTimelineCoverUrls[5],
          evidence: "7 of 8 official albums owned · 7 local albums",
        },
        {
          artistId: "pet shop boys",
          artist: "Pet Shop Boys",
          musicbrainzMbid: "mock-pet-shop-boys",
          ownedAlbumCount: 12,
          officialAlbumCount: 15,
          missingAlbumCount: 3,
          completionPercent: 0.8,
          missingReleaseTitle: "Please",
          missingReleaseYear: 1986,
          genre: "Synthpop",
          portraitAvailable: false,
          representativeAlbumId: "mb:mock-complete-4",
          representativeAlbum: "Actually",
          representativeCoverPath: mockTimelineCoverUrls[1],
          evidence: "12 of 15 official albums owned · 14 local albums",
        },
        {
          artistId: "joni mitchell",
          artist: "Joni Mitchell",
          musicbrainzMbid: "mock-joni-mitchell",
          ownedAlbumCount: 14,
          officialAlbumCount: 19,
          missingAlbumCount: 5,
          completionPercent: 0.74,
          missingReleaseTitle: "Mingus",
          missingReleaseYear: 1979,
          genre: "Jazz",
          portraitAvailable: false,
          representativeAlbumId: "mb:mock-complete-5",
          representativeAlbum: "Hejira",
          representativeCoverPath: mockTimelineCoverUrls[2],
          evidence: "14 of 19 official albums owned · 16 local albums",
        },
        {
          artistId: "prince",
          artist: "Prince",
          musicbrainzMbid: "mock-prince",
          ownedAlbumCount: 24,
          officialAlbumCount: 28,
          missingAlbumCount: 4,
          completionPercent: 0.86,
          missingReleaseTitle: "Controversy",
          missingReleaseYear: 1981,
          genre: "Pop",
          portraitAvailable: false,
          representativeAlbumId: "mb:mock-complete-6",
          representativeAlbum: "Dirty Mind",
          representativeCoverPath: mockTimelineCoverUrls[3],
          evidence: "24 of 28 official albums owned · 25 local albums",
        },
      ],
      albumStories: [
        {
          albumId: "mb:mock-album-gap-1",
          album: "Actually",
          artist: "Pet Shop Boys",
          releaseYear: 1987,
          genre: "Synthpop",
          ...
          completionPercent: 0.8,
          coverPath: mockTimelineCoverUrls[0],
          evidence: "8 of 10 tracks rated",
        },
        {
          albumId: "mb:mock-album-gap-2",
          album: "Dirty Mind",
          artist: "Prince",
          releaseYear: 1980,
          genre: "Pop",
          ...
          ratedTracks: 5,
          unratedTracks: 3,
          completionPercent: 0.625,
          coverPath: mockTimelineCoverUrls[2],
          evidence: "5 of 8 tracks rated",
        },
        {
          albumId: "mb:mock-album-gap-3",
          ...
          ratedTracks: 7,
          unratedTracks: 1,
          completionPercent: 0.875,
          coverPath: mockTimelineCoverUrls[5],
          evidence: "7 of 8 tracks rated",
        },
        {
          albumId: "mb:mock-album-gap-4",
          album: "Mingus",
          artist: "Joni Mitchell",
          releaseYear: 1979,
          genre: "Jazz",
          ...
          coverPath: mockTimelineCoverUrls[1],
          evidence: "3 of 6 tracks rated",
        },
        {
          albumId: "mb:mock-album-gap-5",
    ...
    recommendationSnapshot: {
      ...
      anchors: [
        ...
        {
          albumId: "mb:mock-anchor-2",
          album: "Electric Rendezvous",
          artist: "Al Di Meola",
          signal: "100% rated recently",
          coverPath: mockTimelineCoverUrls[1],
          evidence: "8 of 8 tracks rated in recent activity",
        },
        {
          albumId: "mb:mock-anchor-loved-1",
          album: "Purple Rain",
          artist: "Prince",
          signal: "Album score 418",
          coverPath: mockTimelineCoverUrls[2],
          evidence: "Album score 418 · 4 loved tracks",
        },
        {
          albumId: "mb:mock-anchor-loved-2",
          album: "Hounds of Love",
          artist: "Kate Bush",
          signal: "Album score 312",
          coverPath: mockTimelineCoverUrls[3],
          evidence: "Album score 312 · 3 loved tracks",
        },
      ],
      matchingCount: 24,
      lastfmLinkedCount: 18,
      stories: [
        {
          albumId: "mb:mock-because-1",
          album: "Steve McQueen",
          ...
          anchorAlbumId: "mb:mock-anchor-1",
          anchorAlbum: "Actually",
          anchorArtist: "Pet Shop Boys",
          evidence: "Last.fm links Prefab Sprout to Pet Shop Boys · 0% rated",
        },
        {
          albumId: "mb:mock-because-2",
          ...
          ratedTracks: 2,
          totalTracks: 7,
          ratingCompleteness: 0.286,
          coverPath: mockTimelineCoverUrls[3],
          reason: "Related album",
          anchorAlbumId: "mb:mock-anchor-2",
          anchorAlbum: "Electric Rendezvous",
          anchorArtist: "Al Di Meola",
          evidence: "Related to Electric Rendezvous on Last.fm · 29% rated",
        },
        {
          albumId: "mb:mock-because-3",
          album: "Idlewild",
          ...
          anchorAlbum: "Actually",
          anchorArtist: "Pet Shop Boys",
          evidence: "Last.fm links Everything But The Girl to Pet Shop Boys · 0% rated",
        },
        {
          albumId: "mb:mock-because-4",
          album: "Café Bleu",
          ...
          ratedTracks: 3,
          totalTracks: 13,
          ratingCompleteness: 0.231,
          coverPath: mockTimelineCoverUrls[5],
          reason: "Shared genre",
          anchorAlbumId: "mb:mock-anchor-1",
          anchorAlbum: "Actually",
          anchorArtist: "Pet Shop Boys",
          evidence: "Synthpop link to Actually · 23% rated",
        },
        {
          albumId: "mb:mock-because-5",
          album: "First Light",
          ...
          anchorAlbum: "Electric Rendezvous",
          anchorArtist: "Al Di Meola",
          evidence: "Last.fm links Pat Metheny Group to Al Di Meola · 0% rated",
        },
        {
          albumId: "mb:mock-because-6",
          album: "The Dreaming",
          artist: "Kate Bush",
          lovedTracks: 0,
          albumScore: null,
          ratedTracks: 4,
          totalTracks: 10,
          ratingCompleteness: 0.4,
          coverPath: mockTimelineCoverUrls[3],
          reason: "Related album",
          anchorAlbumId: "mb:mock-anchor-loved-1",
          anchorAlbum: "Purple Rain",
          anchorArtist: "Prince",
          evidence: "Related to Purple Rain on Last.fm · 40% rated",
        },
      ],
      evidence: "2 recent rating threads · suggestions are under 50% rated",
    },
