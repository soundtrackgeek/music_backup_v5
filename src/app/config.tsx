...
export const navigation: { label: string; icon: LucideIcon; enabled: boolean; shortcut: string }[] = [
  ...
  { label: "Published Charts", icon: BarChart3, enabled: true, shortcut: "" },
  ...
  { label: "Updates", icon: FileClock, enabled: true, shortcut: "u" },
...
export const missingFieldOptions: MissingFieldOption[] = [
  ...
  { value: "releaseYear", albumLabel: "Release year", trackLabel: "Album release year" },
  { value: "publisher", albumLabel: "Publisher", trackLabel: "Album publisher" },
  { value: "trackTitle", albumLabel: "Any track title", trackLabel: "Track title" },
  { value: "displayArtist", albumLabel: "Any display artist", trackLabel: "Display artist" },
  { value: "trackNumber", albumLabel: "Any track number", trackLabel: "Track number" },
  { value: "discNumber", albumLabel: "Any disc number", trackLabel: "Disc number" },
  ...
  { value: "officialUk", albumLabel: "Official UK rank", trackLabel: "Official UK rank" },
  { value: "officialUkDebut", albumLabel: "Official UK debut week", trackLabel: "Official UK debut week" },
...
export const rankingOptions = [
  ...
  { value: "officialUkRank", label: "Official UK rank" },
  { value: "officialUkDebut", label: "Official UK debut week" },
...
export const chartColumnOptions = [
  ...
  { value: "vgListaDebut", label: "VG Lista debut week" },
  { value: "officialUk", label: "Official UK" },
  { value: "officialUkDebut", label: "Official UK debut week" },
...
export const searchTableColumnOptions = [
  { value: "audioQuality", label: "Audio quality" },
  { value: "billboard", label: "Billboard" },
  { value: "billboardDebut", label: "Debut week" },
  { value: "billboardSingle", label: "Billboard single" },
  { value: "billboardSingleDebut", label: "Billboard single debut" },
...
export const musicToolCatalog: MusicToolSummary[] = [
  ...
  },
  {
    ...
    description: "Imported Billboard, Official UK, and VG Lista albums not linked to the library.",
    severity: "low",
    scope: "albums",
    issueCount: -1,
    albumCount: -1,
