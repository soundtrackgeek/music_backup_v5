...
- Keep target exactly equal to the supplied target. For charts, preserve the supplied current view unless the request explicitly names albums or tracks.
...
- Named ranking terms map as follows: rating -> albumRating or trackRating; loved -> lovedTracks; Billboard -> billboardRank for albums or billboardSingleRank for tracks; Official UK or Official Charts -> officialUkRank; VG Lista -> vgListaRank; Ti i Skuddet -> tiISkuddetRank for tracks; Norsktoppen -> norsktoppenRank for tracks; completeness -> ratingCompleteness; duration -> totalMinutes; AE -> ae; TMOE -> tmoe.
...
- Official UK and Official Charts refer to the UK source. Exact ranks use officialUkRank, presence uses officialUkRank gte 1, absence uses missingFields officialUk, and debut or first appearance uses officialUkDebutWeek for albums or tracks. Never substitute Billboard or VG Lista fields.
- Ti i Skuddet is singles-only. For tracks, an exact Ti i Skuddet rank uses tiISkuddetRank, presence uses tiISkuddetRank gte 1, absence uses missingFields tiISkuddet, and debut or first appearance uses tiISkuddetDebutWeek. Never substitute VG Lista or Billboard fields. If the user asks for Ti i Skuddet albums, use the tracks view instead when that satisfies the request; Ti i Skuddet fields are invalid in the albums view.
- Norsktoppen is singles-only. For tracks, an exact Norsktoppen rank uses norsktoppenRank, presence uses norsktoppenRank gte 1, absence uses missingFields norsktoppen, and debut or first appearance uses norsktoppenDebutWeek. Never substitute VG Lista, Ti i Skuddet, or Billboard fields. If the user asks for Norsktoppen albums, use the tracks view instead when that satisfies the request; Norsktoppen fields are invalid in the albums view.
- For albums, Billboard debut, first chart appearance, debut week, and first appearance refer to billboardDebutWeek and use ISO year-week values such as 1989-W26. For tracks, those Billboard phrases refer to billboardSingleDebutDate and use exact YYYY-MM-DD dates. When Official UK is named, chart debut or first appearance refers to officialUkDebutWeek for either view and uses an ISO year-week value. When VG Lista is named, chart debut or first appearance refers to vgListaDebutWeek for either view and uses an ISO year-week value. When Ti i Skuddet is named, those phrases refer to tiISkuddetDebutWeek for tracks and use an ISO year-week value. When Norsktoppen is named, those phrases refer to norsktoppenDebutWeek for tracks and use an ISO year-week value. Never encode chart entry as releaseYear. Calendar seasons cover whole named months: spring March-May, summer June-August, autumn/fall September-November, and winter December-February.
- For an album chart, rankingMetric must be one of albumScore, billboardRank, officialUkRank, officialUkDebut, vgListaRank, vgListaDebut, albumRating, lovedTracks, ae, tmoe, ratingCompleteness, totalMinutes. For a track chart it must be trackRating, billboardSingleRank, billboardSingleDebut, officialUkRank, officialUkDebut, vgListaRank, vgListaDebut, tiISkuddetRank, tiISkuddetDebut, norsktoppenRank, norsktoppenDebut, albumScore, or albumRating. Use albumScore for albums and trackRating for tracks when no ranking metric is named.
- sortField must be valid for the selected view. Album sort fields: random, album, artist, year, genre, originCountry, billboardRank, billboardDebut, officialUkRank, officialUkDebut, vgListaRank, vgListaDebut, totalMinutes, trackCount, albumRating, ratingCompleteness, lovedTracks, ae, tmoe, albumScore. Track sort fields: random, album, title, displayArtist, artist, year, genre, originCountry, billboardRank, billboardDebut, billboardSingleRank, billboardSingleDebut, officialUkRank, officialUkDebut, vgListaRank, vgListaDebut, tiISkuddetRank, tiISkuddetDebut, norsktoppenRank, norsktoppenDebut, trackRating, albumRating, time, trackNumber. albumRating on tracks orders candidate tracks by their album's effective rating.
...
- Put missing metadata filters in missingFields using only album, albumArtist, genre, year, releaseYear, publisher, trackTitle, displayArtist, trackNumber, discNumber, filename, coverArt, billboard, billboardDebut, billboardSingle, billboardSingleDebut, officialUk, officialUkDebut, vgLista, vgListaDebut, tiISkuddet, tiISkuddetDebut, norsktoppen, norsktoppenDebut, rating, or time.
- Put exact, minimum, and maximum numeric filters in numericConditions. Fields billboardRank, billboardSingleRank, officialUkRank, vgListaRank, tiISkuddetRank, norsktoppenRank, year, releaseYear, totalMinutes, trackCount, ratedTracks, albumRating, trackRating, ratingCompleteness, lovedTracks, artistBornYear, artistDiedYear, artistFoundedYear, artistDissolvedYear use equals, gte, or lte plus value.
...
- Put exact, minimum, and maximum debut-week filters in weekConditions. Fields billboardDebutWeek, officialUkDebutWeek, vgListaDebutWeek, tiISkuddetDebutWeek, and norsktoppenDebutWeek use equals, gte, and lte; values use YYYY-Www.
...
- All condition arrays are required. Use an empty array when that condition type is not needed.
"#;
...
- Billboard debut, first chart appearance, chart entry, and first appearance mean billboardSingleDebutDate for tracks. Use YYYY-MM-DD date bounds. When Official UK is named, those phrases mean officialUkDebutWeek and use ISO year-week bounds. When VG Lista is named, those phrases mean vgListaDebutWeek and use ISO year-week bounds. When Ti i Skuddet is named, those phrases mean tiISkuddetDebutWeek and use ISO year-week bounds. When Norsktoppen is named, those phrases mean norsktoppenDebutWeek and use ISO year-week bounds. A summer request covers the corresponding full calendar months.
...
- sortField must be one of random, album, title, displayArtist, artist, year, genre, originCountry, billboardRank, billboardDebut, billboardSingleRank, billboardSingleDebut, officialUkRank, officialUkDebut, vgListaRank, vgListaDebut, tiISkuddetRank, tiISkuddetDebut, norsktoppenRank, norsktoppenDebut, trackRating, albumRating, time, or trackNumber.
...
- missingFields supports album, albumArtist, genre, year, releaseYear, publisher, trackTitle, displayArtist, trackNumber, discNumber, filename, coverArt, billboard, billboardDebut, billboardSingle, billboardSingleDebut, officialUk, officialUkDebut, vgLista, vgListaDebut, tiISkuddet, tiISkuddetDebut, norsktoppen, norsktoppenDebut, rating, and time.
- numericConditions fields billboardRank, billboardSingleRank, officialUkRank, vgListaRank, tiISkuddetRank, norsktoppenRank, year, releaseYear, totalMinutes, trackCount, ratedTracks, albumRating, trackRating, ratingCompleteness, lovedTracks, artistBornYear, artistDiedYear, artistFoundedYear, and artistDissolvedYear use equals, gte, or lte.
- numericRangeConditions use minimum and maximum for bounded numeric ranges.
- weekConditions and weekRangeConditions support billboardDebutWeek, officialUkDebutWeek, vgListaDebutWeek, tiISkuddetDebutWeek, and norsktoppenDebutWeek and use YYYY-Www values.
...
struct QueryPlan {
    ...
    #[serde(default)]
    week_conditions: Vec<WeekQueryCondition>,
    #[serde(default)]
    week_range_conditions: Vec<WeekRangeQueryCondition>,
    #[serde(default)]
    date_conditions: Vec<DateQueryCondition>,
    #[serde(default)]
    date_range_conditions: Vec<DateRangeQueryCondition>,
...
#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
struct WeekRangeQueryCondition {
    field: String,
    minimum: String,
    maximum: String,
}
...
#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
struct DateRangeQueryCondition {
    field: String,
    minimum: String,
    maximum: String,
}
...
fn build_compiled_query(
    ...
    let view = match plan.view.as_str() {
    ...
    request.offset = 0;
    validate_chart_source_view(&view, &plan)?;
    ...
    let chart_config = if target == "chart" {
        validate_ranking_metric(&view, &plan.ranking_metric)?;
        if !matches!(
            plan.chart_view.as_str(),
            "table" | "compact" | "grid" | "timeline"
        ) {
        ...
        Some(ChartConfig {
            ...
            visible_columns: if view == "tracks" {
                vec![
                    "billboardSingle".to_string(),
                    "billboardSingleDebut".to_string(),
                    "trackRating".to_string(),
                ]
            } else {
                vec![
                    "billboard".to_string(),
                    "billboardDebut".to_string(),
                    "rating".to_string(),
                    "complete".to_string(),
                    "score".to_string(),
                    "loved".to_string(),
...
fn validate_chart_source_view(view: &str, plan: &QueryPlan) -> Result<()> {
    if view == "tracks" {
        return Ok(());
    }

    let uses_ti_i_skuddet = plan
        .missing_fields
        .iter()
        .any(|field| matches!(field.as_str(), "tiISkuddet" | "tiISkuddetDebut"))
        || plan
            .numeric_conditions
            .iter()
            .any(|condition| condition.field == "tiISkuddetRank")
        || plan
            .numeric_range_conditions
            .iter()
            .any(|condition| condition.field == "tiISkuddetRank")
        || plan
            .week_conditions
            .iter()
            .any(|condition| condition.field == "tiISkuddetDebutWeek")
        || plan
            .week_range_conditions
            .iter()
            .any(|condition| condition.field == "tiISkuddetDebutWeek")
        || matches!(
            plan.sort_field.as_str(),
            "tiISkuddetRank" | "tiISkuddetDebut"
        )
        || matches!(
            plan.ranking_metric.as_str(),
            "tiISkuddetRank" | "tiISkuddetDebut"
        );

    if uses_ti_i_skuddet {
        bail!("Luna returned Ti i Skuddet fields for albums, but Ti i Skuddet is singles-only.")
    }

    let uses_norsktoppen = plan
        .missing_fields
        .iter()
        .any(|field| matches!(field.as_str(), "norsktoppen" | "norsktoppenDebut"))
        || plan
            .numeric_conditions
            .iter()
            .any(|condition| condition.field == "norsktoppenRank")
        || plan
            .numeric_range_conditions
            .iter()
            .any(|condition| condition.field == "norsktoppenRank")
        || plan
            .week_conditions
            .iter()
            .any(|condition| condition.field == "norsktoppenDebutWeek")
        || plan
            .week_range_conditions
            .iter()
            .any(|condition| condition.field == "norsktoppenDebutWeek")
        || matches!(
            plan.sort_field.as_str(),
            "norsktoppenRank" | "norsktoppenDebut"
        )
        || matches!(
            plan.ranking_metric.as_str(),
            "norsktoppenRank" | "norsktoppenDebut"
    ...
    if uses_norsktoppen {
        bail!("Luna returned Norsktoppen fields for albums, but Norsktoppen is singles-only.")
    }
    Ok(())
}
...
fn validate_ranking_metric(view: &str, metric: &str) -> Result<()> {
    let supported = if view == "tracks" {
        &[
            "trackRating",
            "billboardSingleRank",
...
fn apply_plan_conditions(request: &mut BrowseRequest, plan: &QueryPlan) -> Result<()> {
    ...
    for condition in &plan.week_conditions {
        apply_week_condition(
            request,
            &condition.field,
            &condition.operator,
            &condition.value,
    ...
    for condition in &plan.week_range_conditions {
        apply_week_condition(
            request,
            &condition.field,
            "between",
            &condition.minimum,
            Some(&condition.maximum),
        )?;
    }
    for condition in &plan.date_conditions {
    ...
    for condition in &plan.date_range_conditions {
        apply_date_condition(
            request,
            &condition.field,
            "between",
...
fn apply_condition(request: &mut BrowseRequest, condition: &QueryCondition) -> Result<()> {
    match condition.field.as_str() {
        ...
        "officialUkRank" => apply_i32_range(
            condition,
            &mut request.filters.official_uk_rank_min,
            &mut request.filters.official_uk_rank_max,
            1,
            10_000,
        )?,
        "tiISkuddetRank" => apply_i32_range(
            condition,
            &mut request.filters.ti_i_skuddet_rank_min,
            &mut request.filters.ti_i_skuddet_rank_max,
            1,
            10_000,
        )?,
        "norsktoppenRank" => apply_i32_range(
            condition,
            &mut request.filters.norsktoppen_rank_min,
            &mut request.filters.norsktoppen_rank_max,
            1,
            10_000,
        )?,
...
fn apply_week_condition(
    request: &mut BrowseRequest,
    field: &str,
    operator: &str,
    first: &str,
    second: Option<&str>,
    ...
    let (minimum_target, maximum_target) = match field {
        ...
        "officialUkDebutWeek" => (
            &mut request.filters.official_uk_debut_week_from,
            &mut request.filters.official_uk_debut_week_to,
        ),
        "tiISkuddetDebutWeek" => (
            &mut request.filters.ti_i_skuddet_debut_week_from,
            &mut request.filters.ti_i_skuddet_debut_week_to,
        ),
        "norsktoppenDebutWeek" => (
            &mut request.filters.norsktoppen_debut_week_from,
            &mut request.filters.norsktoppen_debut_week_to,
        ),
...
fn checked_iso_week(value: &str) -> Result<String> {
    let normalized = value.trim().to_uppercase();
    let (year, week) = normalized
        .split_once("-W")
        .ok_or_else(|| anyhow!("Luna returned an invalid ISO debut week."))?;
    if year.len() != 4 || week.is_empty() || week.len() > 2 {
        bail!("Luna returned an invalid ISO debut week.")
    }
    let year = year
        .parse::<i32>()
        .map_err(|_| anyhow!("Luna returned an invalid ISO debut year."))?;
    let week = week
        .parse::<u32>()
        .map_err(|_| anyhow!("Luna returned an invalid ISO debut week."))?;
...
fn apply_date_condition(
    ...
    if field != "billboardSingleDebutDate" {
        bail!("Luna returned an unsupported date filter field.")
    }
    let first = checked_iso_date(first)?;
    match operator {
        "equals" => {
            request.filters.billboard_single_debut_date_from = Some(first.clone());
            request.filters.billboard_single_debut_date_to = Some(first);
        }
        "gte" => request.filters.billboard_single_debut_date_from = Some(first),
        "lte" => request.filters.billboard_single_debut_date_to = Some(first),
        "between" => {
            let second = checked_iso_date(
                second.ok_or_else(|| anyhow!("Luna returned an incomplete date range."))?,
            )?;
            let (minimum, maximum) = if first <= second {
                (first, second)
            } else {
            ...
            request.filters.billboard_single_debut_date_from = Some(minimum);
            request.filters.billboard_single_debut_date_to = Some(maximum);
        }
        _ => bail!("Luna returned an invalid date operator."),
    }
    Ok(())
}

fn checked_iso_date(value: &str) -> Result<String> {
    let normalized = value.trim();
    let parsed = NaiveDate::parse_from_str(normalized, "%Y-%m-%d")
        .map_err(|_| anyhow!("Luna returned an invalid chart-entry date."))?;
...
fn query_plan_schema(target: &str) -> Value {
    json!({
        ...
        "properties": {
            ...
            "missingFields": {
                ...
                "items": {
                    ...
                    "enum": [
                        ...
                        "officialUk", "officialUkDebut", "vgLista", "vgListaDebut", "tiISkuddet", "tiISkuddetDebut", "norsktoppen", "norsktoppenDebut", "rating", "time"
                    ]
                },
                "maxItems": 16
            },
                ...
                "items": {
                    ...
                    "properties": {
                        "field": {
                            "type": "string",
                            "enum": [
                                "billboardRank", "billboardSingleRank", "officialUkRank", "vgListaRank", "tiISkuddetRank", "norsktoppenRank", "year", "releaseYear",
            ...
            "weekConditions": {
                ...
                "items": {
                    ...
                    "additionalProperties": false,
                    "properties": {
                        "field": { "type": "string", "enum": ["billboardDebutWeek", "officialUkDebutWeek", "vgListaDebutWeek", "tiISkuddetDebutWeek", "norsktoppenDebutWeek"] },
                        "operator": { "type": "string", "enum": ["equals", "gte", "lte"] },
            ...
            "dateConditions": {
                ...
                "items": {
                    ...
                    "additionalProperties": false,
                    "properties": {
                        "field": { "type": "string", "enum": ["billboardSingleDebutDate"] },
                        "operator": { "type": "string", "enum": ["equals", "gte", "lte"] },
            ...
            "dateRangeConditions": {
                ...
                "items": {
                    ...
                    "properties": {
                        "field": { "type": "string", "enum": ["billboardSingleDebutDate"] },
                        "minimum": { "type": "string", "pattern": "^[0-9]{4}-[0-9]{2}-[0-9]{2}$" },
                        "maximum": { "type": "string", "pattern": "^[0-9]{4}-[0-9]{2}-[0-9]{2}$" }
                    },
                    "required": ["field", "minimum", "maximum"]
                }
            },
            ...
            "sortField": {
                ...
                "enum": [
                    ...
                    "officialUkRank", "officialUkDebut", "vgListaRank", "vgListaDebut", "tiISkuddetRank", "tiISkuddetDebut", "norsktoppenRank", "norsktoppenDebut", "totalMinutes",
            ...
            "rankingMetric": {
                "type": "string",
                "enum": ["albumScore", "billboardRank", "officialUkRank", "officialUkDebut", "vgListaRank", "vgListaDebut", "albumRating", "lovedTracks", "ae", "tmoe", "ratingCompleteness", "totalMinutes", "trackRating", "billboardSingleRank", "billboardSingleDebut", "tiISkuddetRank", "tiISkuddetDebut", "norsktoppenRank", "norsktoppenDebut"]
            },
        ...
        "required": [
            ...
            "numericRangeConditions", "weekConditions", "weekRangeConditions", "dateConditions", "dateRangeConditions", "booleanConditions", "sortField", "sortDirection",
    ...
    properties.insert(
        ...
        json!({
            ...
            "enum": [
                "random", "album", "title", "displayArtist", "artist", "year", "genre",
                "originCountry", "billboardRank", "billboardDebut", "billboardSingleRank", "billboardSingleDebut",
                "officialUkRank", "officialUkDebut", "vgListaRank", "vgListaDebut", "tiISkuddetRank", "tiISkuddetDebut", "norsktoppenRank", "norsktoppenDebut", "trackRating",
...
mod tests {
    ...
    #[test]
    fn compiles_official_uk_rank_and_debut_without_chart_substitution() {
        let plan = QueryPlan {
            ...
            week_conditions: Vec::new(),
            week_range_conditions: vec![WeekRangeQueryCondition {
                field: "officialUkDebutWeek".to_string(),
                minimum: "1995-W01".to_string(),
                maximum: "1995-W52".to_string(),
            }],
            date_conditions: Vec::new(),
            date_range_conditions: Vec::new(),
            boolean_conditions: Vec::new(),
            sort_field: "officialUkDebut".to_string(),
            sort_direction: "asc".to_string(),
            limit: 100,
            ranking_metric: "officialUkRank".to_string(),
            chart_view: "table".to_string(),
            summary: "Official UK number-one singles that debuted in 1995.".to_string(),
        };
        ...
        assert_eq!(compiled.request.filters.official_uk_rank_min, Some(1));
        assert_eq!(compiled.request.filters.official_uk_rank_max, Some(1));
        assert_eq!(
            compiled.request.filters.official_uk_debut_week_from,
            Some("1995-W01".to_string())
        );
        assert_eq!(
            compiled.request.filters.official_uk_debut_week_to,
            Some("1995-W52".to_string())
        );
        assert_eq!(compiled.request.filters.billboard_single_rank_min, None);
        assert_eq!(compiled.request.filters.vg_lista_rank_min, None);
        assert_eq!(compiled.request.sort.field, "officialUkRank");
        assert_eq!(
            compiled.chart_config.expect("chart config").ranking_metric,
            "officialUkRank"
        );
    }
    ...
    #[test]
    fn compiles_ti_i_skuddet_rank_and_debut_for_track_search() {
        let plan = QueryPlan {
            target: "search".to_string(),
            query_intent: "filter".to_string(),
            view: "tracks".to_string(),
            ...
            missing_fields: Vec::new(),
            numeric_conditions: vec![NumericQueryCondition {
                field: "tiISkuddetRank".to_string(),
                operator: "equals".to_string(),
                value: 3.0,
            }],
            numeric_range_conditions: Vec::new(),
            week_conditions: Vec::new(),
            week_range_conditions: vec![WeekRangeQueryCondition {
                field: "tiISkuddetDebutWeek".to_string(),
                minimum: "1989-W20".to_string(),
                maximum: "1989-W30".to_string(),
            }],
            date_conditions: Vec::new(),
            date_range_conditions: Vec::new(),
            boolean_conditions: Vec::new(),
            sort_field: "tiISkuddetDebut".to_string(),
            sort_direction: "asc".to_string(),
            limit: 50,
            ranking_metric: "trackRating".to_string(),
            chart_view: "table".to_string(),
            summary: "Ti i Skuddet No. 3 tracks debuting from week 20 to 30 in 1989.".to_string(),
        };
        ...
        assert_eq!(compiled.request.filters.ti_i_skuddet_rank_min, Some(3));
        assert_eq!(compiled.request.filters.ti_i_skuddet_rank_max, Some(3));
        assert_eq!(
            compiled
                .request
                .filters
                .ti_i_skuddet_debut_week_from
                .as_deref(),
            Some("1989-W20")
        );
        assert_eq!(
            compiled
                .request
                .filters
                .ti_i_skuddet_debut_week_to
                .as_deref(),
            Some("1989-W30")
        );
        assert_eq!(compiled.request.sort.field, "tiISkuddetDebut");
        assert_eq!(compiled.request.filters.billboard_single_rank_min, None);
        assert_eq!(compiled.request.filters.vg_lista_rank_min, None);
    }

    #[test]
    fn rejects_ti_i_skuddet_filters_for_album_search() {
        let plan = QueryPlan {
            target: "search".to_string(),
            query_intent: "filter".to_string(),
            view: "albums".to_string(),
            text_conditions: Vec::new(),
            list_conditions: Vec::new(),
            missing_fields: vec!["tiISkuddet".to_string()],
            ...
            ranking_metric: "albumScore".to_string(),
            chart_view: "table".to_string(),
            summary: "Albums missing Ti i Skuddet data.".to_string(),
        };

        let error = build_compiled_query(
            "search".to_string(),
            plan,
            AiUsage {
                input_tokens: None,
        ...
        assert!(error.to_string().contains("singles-only"));
    }

    #[test]
    fn compiles_norsktoppen_rank_and_debut_for_track_chart() {
        let plan = QueryPlan {
            target: "chart".to_string(),
            query_intent: "filter".to_string(),
            view: "tracks".to_string(),
            ...
            missing_fields: Vec::new(),
            numeric_conditions: vec![NumericQueryCondition {
                field: "norsktoppenRank".to_string(),
                operator: "equals".to_string(),
                value: 1.0,
            }],
            numeric_range_conditions: Vec::new(),
            week_conditions: Vec::new(),
            week_range_conditions: vec![WeekRangeQueryCondition {
                field: "norsktoppenDebutWeek".to_string(),
                minimum: "1989-W20".to_string(),
                maximum: "1989-W30".to_string(),
            }],
            date_conditions: Vec::new(),
            date_range_conditions: Vec::new(),
            boolean_conditions: Vec::new(),
            sort_field: "norsktoppenDebut".to_string(),
            sort_direction: "asc".to_string(),
            limit: 50,
            ranking_metric: "norsktoppenRank".to_string(),
            chart_view: "table".to_string(),
            summary: "Norsktoppen No. 1 tracks debuting from week 20 to 30 in 1989.".to_string(),
        };
        ...
        assert_eq!(compiled.request.filters.norsktoppen_rank_min, Some(1));
        assert_eq!(compiled.request.filters.norsktoppen_rank_max, Some(1));
        assert_eq!(
            compiled
                .request
                .filters
                .norsktoppen_debut_week_from
                .as_deref(),
            Some("1989-W20")
        );
        assert_eq!(
            compiled
                .request
                .filters
                .norsktoppen_debut_week_to
                .as_deref(),
            Some("1989-W30")
        );
        assert_eq!(compiled.request.sort.field, "norsktoppenRank");
        assert_eq!(
            compiled
                .chart_config
                .expect("Norsktoppen chart config")
                .ranking_metric,
            "norsktoppenRank"
        );
        assert_eq!(compiled.request.filters.ti_i_skuddet_rank_min, None);
        assert_eq!(compiled.request.filters.vg_lista_rank_min, None);
    }

    #[test]
    fn rejects_norsktoppen_filters_for_album_search() {
        let plan = QueryPlan {
            target: "search".to_string(),
            query_intent: "filter".to_string(),
            view: "albums".to_string(),
            text_conditions: Vec::new(),
            list_conditions: Vec::new(),
            missing_fields: vec!["norsktoppen".to_string()],
            numeric_conditions: Vec::new(),
            numeric_range_conditions: Vec::new(),
            week_conditions: Vec::new(),
            week_range_conditions: Vec::new(),
            ...
            ranking_metric: "albumScore".to_string(),
            chart_view: "table".to_string(),
            summary: "Albums missing Norsktoppen data.".to_string(),
        };
    ...
    #[test]
    fn carries_billboard_debut_week_ranges_into_playlist_recipes() {
        let document = PlaylistPlanDocument {
            query: QueryPlan {
                target: "search".to_string(),
                query_intent: "filter".to_string(),
                ...
                week_conditions: Vec::new(),
                week_range_conditions: vec![WeekRangeQueryCondition {
                    field: "billboardDebutWeek".to_string(),
                    minimum: "1989-W22".to_string(),
                    maximum: "1989-W35".to_string(),
                }],
                date_conditions: Vec::new(),
                date_range_conditions: Vec::new(),
                boolean_conditions: Vec::new(),
                sort_field: "billboardDebut".to_string(),
                sort_direction: "asc".to_string(),
                limit: 100,
                ranking_metric: "albumScore".to_string(),
                chart_view: "table".to_string(),
                summary: "Tracks from albums that first charted in summer 1989.".to_string(),
            },
            name: "Summer 1989".to_string(),
            description: "A chronological trip through albums debuting that summer.".to_string(),
        ...
        .expect("build debut-week playlist plan");

        assert_eq!(
            plan.request.filters.billboard_debut_week_from.as_deref(),
            Some("1989-W22")
        );
        assert_eq!(
            plan.request.filters.billboard_debut_week_to.as_deref(),
            Some("1989-W35")
        );
        assert_eq!(plan.request.sort.field, "billboardDebut");
    }

    #[test]
    fn compiles_track_chart_entry_dates_and_track_chart_ranking() {
        let plan = QueryPlan {
            target: "chart".to_string(),
            query_intent: "filter".to_string(),
            view: "tracks".to_string(),
            ...
            date_conditions: Vec::new(),
            date_range_conditions: vec![DateRangeQueryCondition {
                field: "billboardSingleDebutDate".to_string(),
                minimum: "1989-06-01".to_string(),
                maximum: "1989-08-31".to_string(),
            }],
            boolean_conditions: Vec::new(),
            sort_field: "billboardSingleDebut".to_string(),
            sort_direction: "asc".to_string(),
            limit: 50,
            ranking_metric: "billboardSingleDebut".to_string(),
            chart_view: "grid".to_string(),
            summary: "Tracks entering the chart during summer 1989.".to_string(),
        };
        ...
        assert_eq!(compiled.request.view, "tracks");
        assert_eq!(
            compiled
                .request
                .filters
                .billboard_single_debut_date_from
                .as_deref(),
            Some("1989-06-01")
        );
        assert_eq!(
            compiled
                .request
                .filters
                .billboard_single_debut_date_to
                .as_deref(),
            Some("1989-08-31")
        );
        let chart = compiled.chart_config.unwrap();
        assert_eq!(chart.ranking_metric, "billboardSingleDebut");
        assert!(chart
            .visible_columns
            .contains(&"billboardSingleDebut".to_string()));
    }
    ...
    fn schema_disallows_extra_properties() {
        ...
        assert!(schema["properties"]["missingFields"]["items"]["enum"]
            .as_array()
            .unwrap()
            .contains(&json!("tiISkuddet")));
        assert!(schema["properties"]["missingFields"]["items"]["enum"]
            .as_array()
            .unwrap()
            .contains(&json!("norsktoppen")));
        assert!(
        ...
        assert!(
            schema["properties"]["numericConditions"]["items"]["properties"]["field"]["enum"]
                .as_array()
                .unwrap()
                .contains(&json!("tiISkuddetRank"))
        );
        assert!(
            schema["properties"]["numericConditions"]["items"]["properties"]["field"]["enum"]
                .as_array()
                .unwrap()
                .contains(&json!("norsktoppenRank"))
        );
        assert!(
        ...
        assert!(
            schema["properties"]["weekConditions"]["items"]["properties"]["field"]["enum"]
                .as_array()
                .unwrap()
                .contains(&json!("tiISkuddetDebutWeek"))
        );
        assert!(
            schema["properties"]["weekConditions"]["items"]["properties"]["field"]["enum"]
                .as_array()
                .unwrap()
                .contains(&json!("norsktoppenDebutWeek"))
        );
    ...
    fn playlist_recipe_schema_is_strict_track_only_and_bounded() {
        ...
        assert!(sort_fields.contains(&json!("billboardSingleDebut")));
        assert!(sort_fields.contains(&json!("tiISkuddetDebut")));
        assert!(sort_fields.contains(&json!("norsktoppenDebut")));
