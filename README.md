...
- **Your Daily Edition** turns Discovery into an editorial story front page sourced only from local evidence: 50-year owned-album anniversaries, exact MusicBrainz artist birthdays and memorials, week-matched imported charts, unrated non-charting tracks on highly rated albums, missing official pure-album release groups for well-represented artists, and recommendations anchored to the latest local rating event. Rating activity is treated as listening evidence; play counts are not required.
