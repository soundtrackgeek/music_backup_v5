...
- Custom chart builder for album filters, include/exclude genre lists, ranking metric, display-only sortable table headers, sort direction, result limit, rating completeness threshold, visible metric columns, and chart view mode.
