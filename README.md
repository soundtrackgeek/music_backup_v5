...
- Settings includes a MusicBrainz Origin Countries panel with status, preview, import, and cancel actions.
...
- Origin-country import trusts verified MusicBrainz artist links first, then non-suspect cache matches, while preserving raw area and begin-area provenance separately from the derived country.
