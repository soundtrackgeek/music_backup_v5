...
- Search and Charts support Billboard chart-debut week from/to filters, debut-week sorting, and columns. The standalone **Timeline** workspace provides **Albums through the years** with built-in and custom month periods, while Luna Search, Chart, and Playlist Builder recipes understand chart-debut periods and calendar seasons such as `summer 1989`.
